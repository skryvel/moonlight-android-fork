...
public class PreferenceConfiguration {
    ...
    private static final String QUEST_CONTROLLER_GAMEPAD_MODE_PREF_STRING = "checkbox_quest_gamepad_mode";
    ...
    private static final boolean DEFAULT_QUEST_CONTROLLER_GAMEPAD_MODE = true;
    ...
    public boolean questControllerGamepadMode;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.questControllerGamepadMode = prefs.getBoolean(QUEST_CONTROLLER_GAMEPAD_MODE_PREF_STRING, DEFAULT_QUEST_CONTROLLER_GAMEPAD_MODE);
